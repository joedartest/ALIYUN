...
$body = '<div style="width:400px; margin:0 auto;">'
			.'<div style="height:80px; line-height:80px; text-align:center; background:#222; color:orange;"><b style="font-size:20px;">'.$Domain.' 确认验证码</b></div>'
			.'<div style="border:1px #ddd solid; border-top:none; background:#f9f9f9; padding:20px; font-size:14px;">'
				...
				.'<div style="padding:15px 0; text-align:right;">webmaster@'.$domain.'</div>'
			.'</div>'
		.'</div>'
;
